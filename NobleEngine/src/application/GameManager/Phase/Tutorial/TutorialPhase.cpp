...
void TutorialPhase::InnerTableEvent()
{
    // テーブル外判定
...
void TutorialPhase::JudgeAndSetCameraAndLoad()
{
    //グラスが地面ついて割れました。
...
void TutorialPhase::PlayerControl()
{
    if (!canControll_) {
        return;
    }
...
void TutorialPhase::DrawMainScreen(const int32_t renderTexture)
{
    //バーの描画
